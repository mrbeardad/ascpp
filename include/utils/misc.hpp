...
constexpr auto display_width(std::string_view str) -> std::optional<size_t> {
  return display_width(utf_conv<char32_t>(str));
}

constexpr auto display_width(std::wstring_view str) -> std::optional<size_t> {
  return display_width(utf_conv<char32_t>(str));
}

constexpr auto display_width(std::u16string_view str) -> std::optional<size_t> {
  return display_width(utf_conv<char32_t>(str));
}
